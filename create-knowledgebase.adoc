...
.. *Modelo de bate-papo*: Escolha entre os modelos de bate-papo Anthroic Claude ou Amazon Nova que estão integrados na Amazon bedrock. Observe que você já deve ter habilitado o modelo de chat da Amazon bedrock.
+
